...
public class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final class Manual {
      ...
      public static final double joystickRotateLeftDeadband = 0.4;  // don't go below 0.2
      public static final double joystickRotateRightDeadband = 0.4;  // don't go below 0.2
    ...
    public static final class Auto {
      ...
      public static final double maxAutoRotatePower = 0.25;
      public static final double slowAutoRotatePower = 0.25;
  ...
  public static final class AutoAlignSubstationConstants {
    ...
    public static final double rotateToleranceDegrees = 5.0;
    ...
    public static final double substationFrontToleranceMeters = 0.10;
  ...
  public static final class LimelightConstants {
    ...
    public static final double singleSubstationAprilTagHeight = 
      OrangeMath.inchesToMeters(54.0); // TODO: adjust for field (VPHS = 55.75)
